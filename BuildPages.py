...
fnames = ["Site/pt/content/metodologia", "Site/pt/content/analise-conclusoes", "Site/pt/content/analise-detalhada", "Site/pt/content/index", 
          "Site/content/methodology", "Site/content/analysis-conclusions", "Site/content/detailed-analysis", "Site/content/index"]
...
for fname in fnames:
    ...
    html_path = Path(f'{fname.replace("content/","")}.html')
